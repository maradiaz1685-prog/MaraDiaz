...
import type { Settings, DaySchedule, Employee, Service, Course, Product, Registration, Distributor } from "./types";
...
export const getDistributors = () => selectAll<Distributor>("distributors");
